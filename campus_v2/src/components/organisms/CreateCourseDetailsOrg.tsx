  ...
  return (
    <div className="w-full h-full flex flex-col justify-start items-start gap-2 p-2 md:order-2 border-light-border dark:border-dark-border rounded-tl-lg rounded-br-lg">
      <div className="w-48 h-48">
        <img className=" border-2 border-light-border  dark:border-dark-border rounded-tl-lg rounded-br-lg w-full h-full object-cover" src={course?.image || ""} alt={course.name || "sin nombre"} />
      </div>
      <h4>{course?.name} </h4>
